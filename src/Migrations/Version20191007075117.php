 ...
 */
final class Version20191007075117 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(80) NOT NULL, alpha2 VARCHAR(10) NOT NULL, alpha3 VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE backpack_backpack_item DROP FOREIGN KEY FK_34801BD731009DBE');
        $this->addSql('ALTER TABLE user_backpack DROP FOREIGN KEY FK_ECB8616931009DBE');
        $this->addSql('ALTER TABLE backpack_backpack_item DROP FOREIGN KEY FK_34801BD7E2EAB6F9');
